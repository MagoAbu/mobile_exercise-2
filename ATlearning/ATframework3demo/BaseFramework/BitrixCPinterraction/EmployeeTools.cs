...
namespace ATframework3demo.BaseFramework.BitrixCPinterraction
{
    ...
    {
        public static void AddNewIntranetUser(Bitrix24_Project userToAdd, Bitrix24_Project portalAdmin, Uri portalUrl, int departmentId = 1)
        {
            AddNewUserByPHP(userToAdd, portalAdmin, portalUrl, departmentId);
        }

        public static void AddNewExtranetUser(Bitrix24_Project userToAdd, Bitrix24_Project portalAdmin, Uri portalUrl)
        {
            AddNewUserByPHP(userToAdd, portalAdmin, portalUrl, 0);
        }

        static void AddNewUserByPHP(
            Bitrix24_Project user,
            Bitrix24_Project portalAdmin,
            Uri portalUri,
            int depID)
        {
        ...
        static void ConfirmEmail(Bitrix24_Project userToConfirm, Uri portalUri, Bitrix24_Project portalAdmin)
        {
        ...
        static string GetUserGroupIds(string targetUserId, Uri portalUri, Bitrix24_Project userToAuth)
        {
        ...
        public static Bitrix24_Project GenerateBxPortalValidUserData(string namePrefix = default, string lastNamePrefix = default)
        {
        ...
        static Bitrix24_Project GenerateUserData(string name, string lastName)
        {
            var user = new Bitrix24_Project();
            user.Name = name;
