...
namespace Aqua.Selenium.General
{
    public class Bitrix24Group
    {
        ...
        string GetIdByName(Uri portalUri, Bitrix24_Project portalAdmin)
        {
        ...
        public void AddUserToGroupByPHP(Bitrix24_Project user, Uri portalUri, Bitrix24_Project portalAdmin)
        {
        ...
        public string CreateGroupIfNotPresent(Uri portalUri, Bitrix24_Project portalAdmin)
        {
        ...
        static void AddUserToGroup(string userId, string groupId, Uri portalUri, Bitrix24_Project portalAdmin)
        {
            string php =
