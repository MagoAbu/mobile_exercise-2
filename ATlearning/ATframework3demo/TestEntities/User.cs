...
{
    public class Bitrix24_Project
    {
        public Bitrix24_Project() { }

        public Bitrix24_Project(string loginAkaEmail, string password, string name, string lastName)
        {
        ...
        public string GetDBid(Uri portalUri, Bitrix24_Project adminUser)
        {
